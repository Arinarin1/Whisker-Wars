//
//  battleOfCatmixia2.swift
//  Whisker Wars
//
//  Created by arinrocksout on 3/16/18.
...
class battleOfCatmixia2: SKScene, SKPhysicsContactDelegate {
    ...
    let player = SKSpriteNode(imageNamed: "sergantPursington.png")
