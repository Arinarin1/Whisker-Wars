...
class battleOfCatimixia4: SKScene, SKPhysicsContactDelegate {
    ...
    func spawnEnemy() {
        ...
        if defaults.string(forKey: "meowbot2") == "meowbot2" {
            ...
            let moveEnemy = SKAction.move(to: endPoint, duration: 5.6)
            let deleteEnemy = SKAction.removeFromParent()
            let loseALifeAction = SKAction.run(loseALife)
            let enemySequence = SKAction.sequence([moveEnemy, deleteEnemy, loseALifeAction])
        ...
        if defaults.string(forKey: "meowbot3") == "meowbot3" {
            ...
            let moveEnemy = SKAction.move(to: endPoint, duration: 4.4)
            let deleteEnemy = SKAction.removeFromParent()
            let loseALifeAction = SKAction.run(loseALife)
            let enemySequence = SKAction.sequence([moveEnemy, deleteEnemy, loseALifeAction])
        ...
        if defaults.string(forKey: "meowbot5") == "meowbot5" {
            ...
            let moveEnemy = SKAction.move(to: endPoint, duration: 4.1)
            let deleteEnemy = SKAction.removeFromParent()
            let loseALifeAction = SKAction.run(loseALife)
            let enemySequence = SKAction.sequence([moveEnemy, deleteEnemy, loseALifeAction])
        ...
        if defaults.string(forKey: "meowbot6") == "meowbot6" {
            ...
            let moveEnemy = SKAction.move(to: endPoint, duration: 4.3)
            let deleteEnemy = SKAction.removeFromParent()
            let loseALifeAction = SKAction.run(loseALife)
            let enemySequence = SKAction.sequence([moveEnemy, deleteEnemy, loseALifeAction])
        ...
        if defaults.string(forKey: "meowbot8") == "meowbot8" {
            ...
            let moveEnemy = SKAction.move(to: endPoint, duration: 3.8)
            let deleteEnemy = SKAction.removeFromParent()
            let loseALifeAction = SKAction.run(loseALife)
            let enemySequence = SKAction.sequence([moveEnemy, deleteEnemy, loseALifeAction])
